...
export function all(onAnswer){
    TimeoutPropabiliry(300, GLOBAL_PROPABILITY)
    .then(() => onAnswer(serverAnswer(articlesStorage)))
    .catch(e => onAnswer(serverAnswer('', 100500, "Propability Error")))
}
...
export function get(id, onAnswer){
    TimeoutPropabiliry(300, GLOBAL_PROPABILITY)
    .then(() => onAnswer(serverAnswer(articlesStorage[mapArticles[id]])))
    .catch(e => onAnswer(serverAnswer('', 100500, "Propability Error")));
}
